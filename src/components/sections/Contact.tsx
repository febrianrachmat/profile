    ...
    >
      <Reveal>
        ...
        <a
          ...
          className="mt-8 inline-flex items-center gap-2 rounded-md border border-accent px-7 py-4 font-mono text-sm text-accent transition-colors hover:bg-accent/10"
        >
